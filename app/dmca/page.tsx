    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative flex min-h-[60svh] items-end overflow-hidden px-5 pb-14 pt-28 md:min-h-[65vh] md:px-12 md:pb-20">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl">
          ...
          <h1 className="max-w-4xl text-5xl font-bold leading-none tracking-tight md:text-8xl">DMCA Policy</h1>
          <p className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-zinc-300 md:text-xl">Report copyright infringement on 4th Ground.</p>
        </div>
      </section>
      <section className="mx-auto max-w-4xl px-5 pb-20 md:px-12">
        <div className="rounded-3xl border-white/10 bg-white/[0.06] p-6 backdrop-blur-md md:p-10">
          ...
          <div className="mt-8 space-y-8 text-zinc-300">
            <div><h2 className="text-2xl font-bold text-white">1. Notice of Infringement</h2><p className="mt-3 leading-relaxed">If you believe content infringes your copyright, send a notice to support@4thground.com with work details, URL, and contact info.</p></div>
            <div><h2 className="text-2xl font-bold text-white">2. Takedown</h2><p className="mt-3 leading-relaxed">We will remove or disable access to allegedly infringing material upon valid notice.</p></div>
            <div><h2 className="text-2xl font-bold text-white">3. Counter-Notice</h2><p className="mt-3 leading-relaxed">If you believe content was removed in error, you may submit a counter-notice to support@4thground.com.</p></div>
          </div>
        </div>
        <p className="mt-6 text-center text-xs leading-relaxed text-zinc-600">Have a legal professional review before launch.</p>
      </section>
