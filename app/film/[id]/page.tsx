    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8 -mt-40 relative z-10">
        ...
        {!access && film.available && (
          <div className="mb-12">
            ...
            <p className="text-xs text-zinc-500 mt-3">Secure checkout.</p>
          </div>
        )}
            ...
            {otherFilms.map((f) =>
              f.available? (
                ...
                >
                  ...
                  <p className="text-sm text-zinc-400 mt-1">From ${f.price_usd}</p>
                </Link>
              ) : (
                <div
                  key={f.id}
                  className="flex-shrink-0 w-72 sm:w-80 md:w-96 snap-start border-neutral-800 rounded-lg hover:border-neutral-600 transition-colors p-2"
                >
      ...
      {showCheckout && (
        <div className="fixed inset-0 z-[9999] bg-black/80 backdrop-blur-xl flex items-center justify-center p-6">
          <div className="w-full max-w-md rounded-3xl bg-zinc-900 border-zinc-800 shadow-2xl overflow-hidden">
            <div className="p-8">
              <h2 className="text-3xl font-bold">Rent {film.title}</h2>
              <p className="text-zinc-400 mt-2">Watch instantly for 7 days in HD.</p>
              ...
              {checkoutStep === 'email' && (
                <div className="mt-8">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl bg-zinc-800 border-zinc-700 px-4 py-4 outline-none focus:border-white"
              ...
              {checkoutStep === 'payment' && checkoutUrl && (
                <div className="mt-6">
                  <iframe src={checkoutUrl} className="w-full h-[600px] rounded-xl border-zinc-700" />
                </div>
              )}
              ...
              <div className="mt-6">
                ...
                <p className="text-zinc-400 mt-3">
                  {checkoutStep === 'email'? 'Enter your email to continue.' : 'Redirecting to secure payment...'}
                </p>
              </div>
