    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative flex min-h-[60svh] items-end overflow-hidden px-5 pb-14 pt-28 md:min-h-[65vh] md:px-12 md:pb-20">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl">
          ...
          <h1 className="max-w-4xl text-5xl font-bold leading-none tracking-tight md:text-8xl">Cookie Policy</h1>
          <p className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-zinc-300 md:text-xl">How 4th Ground uses cookies and similar tech.</p>
        </div>
      </section>
      <section className="mx-auto max-w-4xl px-5 pb-20 md:px-12">
        <div className="rounded-3xl border-white/10 bg-white/[0.06] p-6 backdrop-blur-md md:p-10">
          ...
          <div className="mt-8 space-y-8 text-zinc-300">
            <div><h2 className="text-2xl font-bold text-white">1. What Are Cookies</h2><p className="mt-3 leading-relaxed">Cookies are small files used to keep you signed in, remember preferences, and analyze site usage.</p></div>
            <div><h2 className="text-2xl font-bold text-white">2. Types We Use</h2><p className="mt-3 leading-relaxed">Essential: required for login and checkout. Analytics: help us improve performance. We do not use advertising cookies.</p></div>
            <div><h2 className="text-2xl font-bold text-white">3. Manage Cookies</h2><p className="mt-3 leading-relaxed">You can disable cookies in your browser, but some features may not work.</p></div>
          </div>
        </div>
